...
### Q2
`chainId` is not initialized explicitly.
https://github.com/code-423n4/2023-03-zksync/blob/21d9a364a4a75adfa6f1e038232d8c0f39858a64/contracts/SystemContext.sol#L21
If any contract reads the value of `chainId` from `SystemContext`, it may give wrong result.
